...
use crate::model::{default_quant_file, EngineType, ModelDescriptor, ModelSource, QuantFile};
use crate::model_capabilities::{CapabilityProbe, Compatibility};
...
mod tests {
    use super::*;
    use crate::model_capabilities::KNOWN_ARCHES;
